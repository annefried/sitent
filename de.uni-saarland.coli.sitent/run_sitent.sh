...
LIBLINEAR_INSTALL_DIR=~/software/liblinear
...
java -jar target/de.uni-saarland.coli.sitent-0.0.1-SNAPSHOT-experimenter.jar $EXPERIMENT_CONFIG $CRFPP_INSTALL_DIR $LIBLINEAR_INSTALL_DIR $CRFSUITE_INSTALL_DIR
