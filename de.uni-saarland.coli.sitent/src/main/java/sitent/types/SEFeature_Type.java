...
public class SEFeature_Type extends Annotation_Type {
  ...
  public final static int typeIndexID = SEFeature.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("sitent.types.SEFeature");
  ...
  public String getName(int addr) {
      ...
      jcas.throwFeatMissing("name", "sitent.types.SEFeature");
  ...
  public String getValue(int addr) {
      ...
      jcas.throwFeatMissing("value", "sitent.types.SEFeature");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public SEFeature_Type(JCas jcas, Type casType) {
    super(jcas, casType);
